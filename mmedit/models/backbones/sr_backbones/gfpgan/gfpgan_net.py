...
from mmedit.models.registry import BACKBONES, COMPONENTS
...
class GFPGANv1(nn.Module):
    ...
    def __init__(
        ...
        if 'params_ema' in state_dict:
            ...
            keyname = 'params'
        self.load_state_dict(state_dict[keyname], strict=True)
...
class StyleGAN2Discriminator(nn.Module):
    ...
    def __init__(self, out_size, channel_multiplier=2, resample_kernel=(1, 3, 3, 1), stddev_group=4, narrow=1, pretrained=None):
        super().__init__()
